...
const formats = {
  combined : ':remote-addr - :remote-user [:date[clf]] ":method :url HTTP/:http-version" :status :length ":referrer" ":user-agent"',
 ...
 * @return {[type]}               [description]
 */
token('remote-user', function getRemoteUserToken(ctx) {
